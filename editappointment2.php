                     ...
                     <div id="employee_table">  
                          <table class="table table-bordered">  
                               ...
                               <tr>  
                                    ...
                                    <td><input type="button" name="edit" value="Edit" id="<?php echo $row["rec_id"]; ?>" class="btn btn-info btn-xs edit_data" /></td>  
                                    <td><input type="button" name="view" value="view" id="<?php echo $row["rec_id"]; ?>" class="btn btn-info btn-xs view_data" /></td>  
                               </tr>  
                               <?php  
                               }  
                               ?>  
