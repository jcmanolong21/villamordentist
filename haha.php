...
$conn=mysqli_connect("localhost","id7227916_lmvillamor","123456","id7227916_lmvillamor");
...
<b>13. Do you have or have you had any of the following??&emsp;&emsp;
&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&ensp;&ensp;&ensp;&nbsp;
					<select name="disease" size="1"></br>
						<option value="Yes">Yes</option>
						<option value="No">No</option>
						</select></br>
						<input type="checkbox" name="highblood" value="High Blood Pressure">&nbsp;<label>High Blood Pressure</label>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
						<input type="checkbox" name="heartDisease" value="Heart Disease">&nbsp;<label>Heart Disease</label>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<input type="checkbox" name="cancerTumors" value="Cancer / Tumors">&nbsp;<label>Cancer / Tumors &nbsp;</label></br>
						<input type="checkbox" name="lowblood" value="Low Blood Pressure">&nbsp;<label>Low Blood Pressure</label>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&ensp;<input type="checkbox" name="heartMurmur" value="Heart Murmur"><label>&nbsp;Heart Murmur</label>&emsp;&emsp;&emsp;&emsp;&ensp;&ensp;&ensp;&nbsp;&nbsp;<input type="checkbox" name="anemia" value="Anemia">&nbsp;<label>Anemia</label></br>			
						<input type="checkbox" name="epilepsy" value="Epilepsy / Convulsions">&nbsp;<label>Epilepsy / Convulsions</label>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&ensp;<input type="checkbox" name="hepatitis" value="Hepatitis / Liver Disease"><label>&nbsp;Hepatitis / Liver Disease</label>&emsp;&ensp;<input type="checkbox" name="angina" value="Angina">&nbsp;<label>Angina</label></br>	
						<input type="checkbox" name="aidsHiv" value="AIDS or HIV Infection">&nbsp;<label>AIDS or HIV Infection</label>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&ensp;&ensp;<input type="checkbox" name="rheumatic" value="Rheumatic Fever"><label>&nbsp;Rheumatic Fever</label>&emsp;&emsp;&emsp;&ensp;&emsp;&nbsp;<input type="checkbox" name="asthma" value="Asthma">&nbsp;<label>Asthma</label></br>	
						<input type="checkbox" name="std" value="Sexually Transmitted Disease">&nbsp;<label>Sexually Transmitted Disease</label>&emsp;&emsp;&ensp;&ensp;&nbsp;<input type="checkbox" name="hayfever" value="Hay Fever / Allergies"><label>&nbsp;Hay Fever / Allergies</label>&emsp;&ensp;&ensp;&ensp;&ensp;<input type="checkbox" name="emphysema" value="Emphysema">&nbsp;<label>Emphysema</label></br>
						<input type="checkbox" name="stomach" value="Stomach Troubles / Ulcers">&nbsp;<label>Stomach Troubles / Ulcers</label>&emsp;&emsp;&emsp;&emsp;&ensp;&nbsp;<input type="checkbox" name="respiratory" value="Respiratory Problems"><label>&nbsp;Respiratory Problems</label>&emsp;&emsp;&ensp;&nbsp;<input type="checkbox" name="bleeding" value="Bleeding Problems">&nbsp;<label>Bleeding Problems</label></br>	
						<input type="checkbox" name="feinting" value="Feinting Seizure">&nbsp;<label>Feinting Seizure</label>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&ensp;&emsp;&ensp;&nbsp;<input type="checkbox" name="hepatitis2" value="Hepatitis / Jundice"><label>&nbsp;Hepatitis / Jundice</label>&emsp;&ensp;&emsp;&emsp;&ensp;&nbsp;<input type="checkbox" name="bloodDisease" value="Blood Diseases">&nbsp;<label>Blood Diseases</label></br>	
						<input type="checkbox" name="rapid" value="Rapid Weight Loss">&nbsp;<label>Rapid Weight Loss</label>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&ensp;&nbsp;&nbsp;<input type="checkbox" name="tuberculosis" value="Tuberculosis"><label>&nbsp;Tubercolosis</label>&emsp;&emsp;&emsp;&emsp;&ensp;&emsp;&emsp;&ensp;<input type="checkbox" name="headInjuries" value="Head Injuries">&nbsp;<label>Head Injuries</label></br>	
						<input type="checkbox" name="radiation" value="Radiation Therapy">&nbsp;<label>Radiation Therapy</label>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&ensp;&nbsp;&ensp;<input type="checkbox" name="swollen" value="Swollen Ankles"><label>&nbsp;Swollen Ankles</label>&emsp;&emsp;&emsp;&emsp;&ensp;&emsp;&nbsp;<input type="checkbox" name="arthritis" value="Arthritis / Rheumatisim">&nbsp;<label>Arthritis / Rheumatisim</label></br>	
						<input type="checkbox" name="joint" value="Joint Replacement / Implant">&nbsp;<label>Joint Replacement / Implant</label>&emsp;&emsp;&emsp;&emsp;<input type="checkbox" name="kidney" value="Kidney Disease"><label>&nbsp;Kidney Disease</label>&emsp;&emsp;&emsp;&emsp;&ensp;&emsp;&nbsp;<input type="checkbox" name="others" value="Other">&nbsp;<label>Other</label></br>	
						<input type="checkbox" name="heartSurguery" value="Heart Surgery">&nbsp;<label>Heart Surgery</label>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;<input type="checkbox" name="diabetes" value="Diabetes"><label>&nbsp;Diabetes</label></br>	
						<input type="checkbox" name="heartAttack" value="Heart Attack">&nbsp;<label>Heart Attack</label>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<input type="checkbox" name="chest" value="Chest Pain"><label>&nbsp;Chest Pain</label></br>
						<input type="checkbox" name="thyroid" value="Thyroid Problem">&nbsp;<label>Thyroid Problem</label>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;<input type="checkbox" name="stroke" value="Stroke"><label>&nbsp;Stroke</label></br>	
