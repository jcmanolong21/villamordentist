...
while($rows=mysqli_fetch_array($result)){
	echo "<tr>";
				...
				echo '<td><input class="btn btn-danger" type=button onClick=deleteme('.$rows['id'].') name=Delete value=Delete></td>';		
           ...
           <div class="modal-content">  
                ...
                <div class="modal-body">  
					...
					<select name="allergic" id="allergic">
						...
						&emsp;&emsp;&emsp;&emsp;<input type="checkbox" name="opt1" id="opt1" value="$row['opt1']" />Local Anesthetic(ex. Lidocaine)</label> &nbsp;
						<input type="checkbox" name="opt2" id="opt2" value="Penicillin Antibiotics">&nbsp;<label>Penicillin Antibiotics</label></br>
