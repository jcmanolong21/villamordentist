...
include('cekadmin.php');
 ...
 $query = "SELECT * FROM t_records ORDER BY t_id DESC";  
		...
		<div class="col-md-9">
            ...
            <div class="panel panel-default">
              <div class="panel-heading main-color-bg">
                <h3 class="panel-title	">Treatment Records</h3>
              </div>
              <div class="panel-body">
     <?php
				$conn=mysqli_connect("localhost","root","","lmvillamor");
					$query1 = "SELECT COUNT(*) c FROM t_records";
		...
		<div align="right">
							...
							<center><?php echo "<b>Total number of data:</b>" ,$row1['c']; ?></center>
            <thead>
     	<div class='ex1'>
      <table class='table table-bordered' id ='employee_table'>  
		   ...
		   <?php  
                               ...
                               {  
								...
								echo '<td><input type="button" name="edit" value="Open" id="' .$row["t_id"].'" class="btn btn-info btn-xs edit_data" /></td>';
								echo '<td><input class="btn btn-danger" type=button onClick=deleteme('.$row['t_id'].') name=Delete value=Delete></td>';		
 ...
 <div id="add_data_Modal" class="modal fade">  
      <div class="modal-dialog" style="width:1200px;">  
           <div class="modal-content">  
                <div class="modal-header">  
                     <button type="button" class="close" data-dismiss="modal">&times;</button>  
                     <h4 class="modal-title">TREATMENT RECORD</h4>  
                </div>  
