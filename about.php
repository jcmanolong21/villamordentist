	...
	<div class="s_bg">
		<div class="wrap">
			<div class="cont_main">
				<div class="content">
					<h2>About Us</h2>
					<h4>Lalit M. Villamor Dentist,</h4>
					<p>
						<a href="#">
							<img src="images/lalitfront.png">
						</a>Hello, Welcome to our website, Lalit M. Villamor Dentist is located at Pelaez St. Cebu City.
					Business hours starts at 8am-5pm, Monday to Saturday. Feel free to check on our contact page for more information.</p>
					<p class="top">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form,
						...
						Internet. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures,</p>
					<p class="top">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form,
						by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage
						of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text. All the Lorem Ipsum
						generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the
